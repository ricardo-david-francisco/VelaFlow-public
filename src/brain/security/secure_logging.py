...
- Safe export function for debugging (shareable output)
...
class SecureLogger:
    ...
    def export_sanitised(self, output_path: str | Path | None = None) -> Path:
        """Export all logs with double-redaction, safe to share for debugging."""
        ...
        lines = [
            ...
            "> have been automatically redacted. Safe to share for debugging.",
            "",
        ]
