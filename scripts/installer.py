...
def step_logging(config: ConfigBuilder) -> None:
    ...
    print("  - Safe export command for debugging\n")
...
def export_logs(output_path: Path | None = None) -> Path:
    """Export sanitised logs that are safe to share for debugging."""
    ...
    lines = [
        ...
        "> a GitHub issue or a support ticket for debugging help.",
        "",
    ]
    ...
    _info("Safe to paste into a GitHub issue or a support ticket.")
    ...
    while True:
        ...
        choice = _menu(
            ...
            [
                ...
                ("5", "Export Logs  (sanitised, safe to share)"),
                ("0", "Exit"),
            ],
        )
